...
import com.proxima.api.security.CustomUserDetailsService;
import com.proxima.api.security.JwtAuthenticationEntryPoint;
import com.proxima.api.security.JwtAuthenticationFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
                ...
                .authorizeRequests()
                    ...
                    .permitAll()
                .antMatchers("/cause/casueType","/cause/create","/cause/organization")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/api/polls/**", "/api/users/**","/organization/users/**")
                .permitAll()
                .anyRequest()
                .authenticated();
